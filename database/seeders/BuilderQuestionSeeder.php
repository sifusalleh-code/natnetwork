...
class BuilderQuestionSeeder extends Seeder
{
    ...
    {
        $questions = [
            ['project_type', 'Apakah yang anda mahu bina?', 'single_choice', true, null, ['website-development' => 'Website Development', 'e-commerce' => 'E-Commerce', 'custom-web-applications' => 'Custom Web Applications', 'ai-automation' => 'AI & Automation', 'system-api-integration' => 'System/API Integration', 'maintenance-support' => 'Maintenance & Support']],
